/**
 * GET /api/political/segments/[id]/response-summary
 *
 * Same-origin proxy → GET /api/v1/datastore/segments/<id>/response-summary/ on backstage.
...
export async function GET(
  ...
  const upstreamUrl = `${BASE_URL}/api/v1/datastore/segments/${encodeURIComponent(id)}/response-summary/${qs ? `?${qs}` : ""}`;
